...
function UniversitySignupPage() {
    return (
        <div className="border-2 border-green-500 mt-10 py-4 mx-4 rounded-xl lg:w-2/6 lg:mx-auto">
          <h1 className="mb-6 text-2xl"><span className="text-green-500">Sign Up </span> Page For University</h1>
          <form className="flex flex-col justify-center items-center gap-2">
            ...
            <div className="flex border-2 h-fit w-3/4  bg-gray-300">
              ...
              <textarea placeholder='describe about the university' rows="2" cols="50" className='px-2'></textarea>
            </div>
            <div className="flex border-2 h-10 w-3/4  bg-gray-300">
